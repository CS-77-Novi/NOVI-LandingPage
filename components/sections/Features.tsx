        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {FEATURES.map((feat, i) => (
            <RevealOnScroll key={i} delay={i * 0.07}>
              <motion.div
                className={`relative overflow-hidden bg-white/[0.03] border border-white/10 rounded-2xl p-7 cursor-default feature-card-top transition-all duration-300 ${glowMap[feat.glow as keyof typeof glowMap]} hover:-translate-y-1.5`}
