...
export const TEAM = [
  { initials: "PN", name: "Onaya", role: "ML Engineer", bio: "Priya leads the computer vision pipeline for NOVI, specializing in real-time gaze tracking and facial landmark detection using MediaPipe and PyTorch.", img: "/team/priya-nair.jpg", socials: ["LinkedIn", "GitHub"], angle: 0, ring: "inner" },
  { initials: "AM", name: "Sethumdee", role: "Full-Stack Developer", bio: "Arjun architects the NOVI platform, building the Next.js frontend and FastAPI backend that powers real-time engagement analytics.", img: "/team/arjun-mehta.jpg", socials: ["LinkedIn", "GitHub"], angle: 120, ring: "inner" },
  { initials: "SR", name: "Yunus", role: "UI/UX Designer", bio: "Sana crafts the NOVI experience — from the cyber-dark design system to the Kids Mode interface — ensuring every interaction is both functional and delightful.", img: "/team/sana-rashid.jpg", socials: ["LinkedIn", "Dribbble"], angle: 240, ring: "inner" },
  { initials: "RD", name: "Chathila", role: "ML Researcher", bio: "Rohan focuses on audio-based distraction signals: ambient noise classification, speech energy detection, and multi-modal fusion with visual cues.", img: "/team/rohan-das.jpg", socials: ["LinkedIn", "ResearchGate"], angle: 60, ring: "outer" },
  { initials: "FK", name: "Gayani", role: "Product Manager", bio: "Fatima bridges the gap between pedagogy and technology, ensuring NOVI's features align with real classroom needs across K-12, university, and corporate environments.", img: "/team/fatima-alkaabi.jpg", socials: ["LinkedIn", "Twitter"], angle: 180, ring: "outer" },
  { initials: "ZM", name: "Abdullah", role: "Backend & DevOps", bio: "Zain manages NOVI's infrastructure — WebSocket sessions, scalable ML inference, Docker deployments, and CI/CD pipelines on AWS.", img: "/team/zain-malik.jpg", socials: ["LinkedIn", "GitHub"], angle: 300, ring: "outer" },
];
