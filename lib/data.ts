...
export const TEAM = [
  ...
  { initials: "RD", name: "Team Lead & Chathila Wijesinghe", role: "ML Engineer", bio: "Chathila leads the computer vision pipeline for NOVI, specializing in real-time gaze tracking and facial landmark detection using MediaPipe and PyTorch", img: "/team/Chathila.jpg", socials: ["LinkedIn", "GitHub"], angle: 60, ring: "outer" },
];
